...
export const mockMessages: Message[] = [
  ...
  // Piece 9 (09-event-type-BRIEF.md) — fixtures exercising the event kinds
  // no message previously demoed: defer/error subjects (both ticket-kind,
  // like claim/done/blocked above), a real supersede (thread-kind subject),
  // and one deliberately DANGLING claim — law #3's "renders as plain text,
  // never a dead link" case, a real-world scenario (the ticket it names was
  // pruned from the board; the historical log entry naturally outlives it).
  {
    id: 'msg_01JQh10',
    from: 'compositor',
    type: 'defer',
    ts: '2026-07-17T15:05:00Z',
    host: 'studio-markup',
    to: ['all'],
    cc: [],
    topic: 'studio-markup',
    summary: 'parked pending the region-streaming decision',
    body: 'Parking req_01JQd21 — needs the region-streaming decision settled first.',
    of: 'msg_01JQd21',
    replyTo: null,
    supersedes: null,
    refs: [],
  ...
  },
  {
    ...
    from: 'pipeline',
    type: 'error',
    ts: '2026-07-17T15:08:00Z',
    host: 'studio',
    to: ['pipeline'],
    cc: [],
    topic: 'plate-pipeline',
    summary: 'per-region loop hit an OOM past 200 plates',
    body: 'The eager per-region loop OOMs past 200 plates on a 24GB card — needs the batched rewrite req_01JQe88 is tracking.',
    of: 'msg_01JQe88',
    replyTo: null,
    supersedes: null,
    refs: [],
  ...
  },
  {
    ...
    from: 'reader',
    type: 'supersede',
    ts: '2026-07-17T15:10:00Z',
    host: 'reader',
    to: ['pipeline'],
    cc: [],
    topic: 'reader',
    summary: 'the restore-chain context note is stale — plate count changed',
    body: 'Superseding the restore-chain context — the plate count assumption changed after the alignment pass.',
    of: null,
    replyTo: null,
    supersedes: 'msg_01JQf01',
    refs: [],
    seenBy: [],
  },
  {
    ...
    from: 'jarvis',
    type: 'claim',
    ts: '2026-07-17T15:12:00Z',
    host: 'jarvis',
    to: ['all'],
    cc: [],
    topic: 'reader',
    summary: 'claimed req_purged — ticket no longer on the board',
    body: 'Claiming this — though the ticket it was filed under has since been pruned.',
    of: 'msg_purged',
    replyTo: null,
    supersedes: null,
    refs: [],
